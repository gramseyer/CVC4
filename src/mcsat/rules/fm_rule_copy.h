 ...
 */
class FourierMotzkinRuleCopy : public ProofRule {
  ...
  /** Resolvent */
  lra::LinearConstraint d_resolvent;
   ...
   */
  static void resolve(Variable x, lra::LinearConstraint& c1, lra::LinearConstraint& c2);

  friend class FourierMotzkinRuleDiseqCopy;

public:

  /** Create a new Fourier-Motzkin resolution */
  FourierMotzkinRuleCopy(ClauseDatabase& clauseDB, const SolverTrail& trail);
  ...
  const lra::LinearConstraint& getCurrentResolvent() const;
 ...
 */
class FourierMotzkinRuleDiseqCopy : public ProofRule {

public:

  FourierMotzkinRuleDiseqCopy(ClauseDatabase& clauseDB, const SolverTrail& trail);
