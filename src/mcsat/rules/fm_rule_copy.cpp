...
FourierMotzkinRuleCopy::FourierMotzkinRuleCopy(ClauseDatabase& clauseDB, const SolverTrail& trail)
: ProofRule("mcsat::fourier_motzkin_rule_copy", clauseDB, trail)
, d_trueCount(0)
{
}

const LinearConstraint& FourierMotzkinRuleCopy::getCurrentResolvent() const {
  return d_resolvent;    
}

void FourierMotzkinRuleCopy::start(Literal lit) {
...
void FourierMotzkinRuleCopy::resolve(Variable var, LinearConstraint& c1, LinearConstraint& c2) {
...
void FourierMotzkinRuleCopy::resolve(Variable var, Literal ineq) {
...
CRef FourierMotzkinRuleCopy::finish(SolverTrail::PropagationToken& propToken) {
...
FourierMotzkinRuleDiseqCopy::FourierMotzkinRuleDiseqCopy(ClauseDatabase& clauseDB, const SolverTrail& trail)
: ProofRule("mcsat::fourier_motzkin_rule_diseq", clauseDB, trail)
{
}


CRef FourierMotzkinRuleDiseqCopy::resolveDisequality(Variable var, Literal varL, Literal varU, Literal D, SolverTrail::PropagationToken& propToken) {
  ...
  FourierMotzkinRuleCopy::resolve(var, varL_constraint, c2);
  ...
  FourierMotzkinRuleCopy::resolve(var, varU_constraint, c1);
